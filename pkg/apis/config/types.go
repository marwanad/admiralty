...
type ProxyArgs struct {
	...
	// Configuring this is useful when using 3rd party schedulers in target clusters
	// that have different scheduling speeds. Lower values will prevent blocking the
	// scheduling loop in case the scheduler is misbehaving in the target clusters
